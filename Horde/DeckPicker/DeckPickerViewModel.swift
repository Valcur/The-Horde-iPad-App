...
class DeckPickerViewModel: ObservableObject {
    ...
    init() {
        ...
        self.deckPickers = [
            DeckPicker(title: "Zombie", intro: "The original horde deck by Peter Knudson", specialRules: "All creatures controlled by the Horde have haste", image: "Zombie", imageArtist: "Ryan Yee"),
            DeckPicker(title: "Human", intro: "Humans are a resilient and tenacious creature type. Alone, they might be weak, but together, they can form a devastating wall of force and destruction. This Horde works together to bolster each other so that the whole is far more powerful than the sum of its parts.", specialRules: "All creatures controlled by the Horde have haste and are Humans in addition to their other creature types.", image: "Human", imageArtist: "Karl Kopinski"),
            ...
            DeckPicker(title: "Dinosaur", intro: "The ground quakes. A roar echoes through the jungle. Every living thing flees for safety as the trees are smashed to splinters revealing a hulking mass and gnashing teeth. This Horde is packed full of massive beasts that can trample over your defenses.", specialRules: " All creatures controlled by the Horde have haste.", image: "Dinosaur", imageArtist: "Grzegorz Rutkowski"),
